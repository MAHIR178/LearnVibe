...
$name = $_SESSION["full_name"] ?? $_SESSION["name"] ?? $_SESSION["email"] ?? "Instructor";


if (empty($_COOKIE["i_name"])) {
    setcookie("i_name", $name, time() + (60 * 60 * 24 * 30), "/");
}
...
<div class="welcome-msg">
  Thanks for Joining us, <?php echo htmlspecialchars($showName); ?>
</div>
